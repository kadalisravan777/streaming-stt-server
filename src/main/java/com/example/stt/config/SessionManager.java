...
public class SessionManager {
     ...
     */
    public void storeSessionMetadata(String sessionId, String conversationId, String participantId) {
        sessionMap.put(sessionId, new SessionMetadata(conversationId, participantId));
    }
